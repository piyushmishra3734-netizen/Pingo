...
/**
 * The Settings row and the add-your-number sheet, at `/dev/secure-lab`, with a
 * pretend backend.
 *
 ...
 * row opens the sheet the way Settings does; the buttons open it at each step.
 */
  ...
  return (
    <div className="h-full bg-page">
      <div className="px-3 pt-4">
        <PhoneRowCard onClick={() => openAt('phone')} />
      </div>
